<template>
    <div class="container">
        <section class="main-wrapper">
            <div class="side">
                <h3>Categories</h3>
                <label @change="filterProducts" v-for="(cat, i) in categories" :key="i"><input type="checkbox"
                        v-model="selected_categories" :value="cat"> {{ cat }}</label>
                <hr>

                <h3>Colors</h3>
                <label @change="filterProducts" v-for="(color, i) in colors" :key="i"><input type="checkbox"
                        v-model="selected_colors" :value="color"> {{ color }}</label>
                <hr>
