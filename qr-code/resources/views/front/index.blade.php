...
<div id="app">
    <div class="hero_area">
        ...
        <section class=" slider_section position-relative">
            <div class="design-box">
                <img src="{{asset('frontend')}}/images/design-1.png" alt="">
            </div>
        ...
        <div class="container">
            <div class="item_container">
                <div class="box">
                    ...
                    <div class="img-box">
                        <img src="{{asset('frontend')}}/images/i-1.png" alt="">
                    </div>
                    <div class="name">
                        <h5>
                            Bracelet
                ...
                <div class="box">
                    ...
                    <div class="img-box">
                        <img src="{{asset('frontend')}}/images/i-2.png" alt="">
                    </div>
                    <div class="name">
                        <h5>
                            Ring
                ...
                <div class="box">
                    ...
                    <div class="img-box">
                        <img src="{{asset('frontend')}}/images/i-3.png" alt="">
                    </div>
                    <div class="name">
                        <h5>
                            Earings
    ...
    <section class="about_section layout_padding2-top layout_padding-bottom">
        <div class="design-box">
            <img src="{{asset('frontend')}}/images/design-2.png" alt="">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-6">
    ...
    <section class="price_section layout_padding">
        <div class="container">
            ...
            <villa-component></villa-component>
        ...
        <div class="container">
            <div class="ring_container layout_padding2">
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="img-box">
                            <img src="{{asset('frontend')}}/images/ring-img.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
